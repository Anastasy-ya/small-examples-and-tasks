/*Проверить, что введенная строка заканчивается символом новой строки, меньше 100 символов,
начинается с "_" или с латинской буквы в любом регистре, не содержит других
симв кроме "_", латинских букв в любом регистре и цифр. Вывести Yes or No*/
